...
<footer class="page-footer font-small blue pt-3" style="background-color:Gray;">
  <div class="row">
   ...
   <div class="container-fluid text-center text-md-center col-md-8" style="font-family: fantasy; font-size:20px; background-color: lightgray; font-color: gray">
    <B>UPDATE BOOKING DETAILS - Search for your Booking</B>
  </div>
  <div class="col-md-2">
   </div>
</div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-6">
  <form action="http://localhost/hotel/upmid.php" method="get" >
    <div class="form-group">
      <label for="cid">Customer ID</label>
    <input type="text" class="form-control" id="cid" name="cid" placeholder="Enter Customer ID" required>
  </div>
  ...
  <br>
  <center>
  <button type="submit" class="btn btn-primary" style="width: 150px; background-color: black">SEARCH BOOKING</button>
  </center>
</form>
</div>
    <div class="col">
