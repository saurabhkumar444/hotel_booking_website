<?php 
  ...
  if($room == 'Custom'){
    ...
    $sql="DELETE FROM CUSTOM_ROOMS WHERE REG_ID=$cid";
    $result=mysqli_query($conn,$sql);
    
  }
  
  elseif ($room== 'Premium') {
    $sql="DELETE FROM PREMIUM_ROOMS WHERE REG_ID=$cid";
    $result=mysqli_query($conn,$sql);
  }
  elseif ($room== 'Super Deluxe') {
    $sql="DELETE FROM SUPER_DELUXE_ROOMS WHERE REG_ID=$cid";
    $result=mysqli_query($conn,$sql);
  }
...
<div class="alert alert-light alert-dismissible fade show" role="alert">
  <strong>Booking Cancel Confirmation!</strong> Your booking deleted successfully
...
<a button type="submit" class="btn btn-primary" style="width: 150px; background-color: black" href="home.html">BACK TO HOME</a>
