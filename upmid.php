...
<footer class="page-footer font-small blue pt-3" style="background-color:Gray;">
  <div class="row">
   ...
   <div class="container-fluid text-center text-md-center col-md-8" style="font-family: fantasy; font-size:20px; background-color: lightgray; font-color: gray">
    <B>UPDATE ROOM DETAILS - Confirm Registration Id</B>
  </div>
  <div class="col-md-2">
   </div>
</div>
...
$mysql="SELECT USERNAME,PASSCODE from CUSTOMER_DETAIL WHERE  REG_ID=$cid";
	
if ($conn->query($mysql) == TRUE) {
    echo "<center><h2><b>FOUND YOUR BOOKING !!!</b></h2></center>";
	...
	if($user==$username){
		...
		{
			echo "<center><h2><b>AUTHORIZED USER !!!</b></h2></center>";
		}
		else{
			echo "<center><h2><b>CHECK THE PASSWORD !!!</b></h2></center>";
			$cid='Error.Search anew';
		}
	}
	else{
		echo "<center><h2><b>INVALID USERNAME !!!</b></h2></center>";
		$cid='Error.Search anew';
		}
	}
    ...
    echo "<center><h2><b>RECORD NOT FOUND !!!</b></h2></center> " . $mysql . "<br>" . $conn->error;
    $cid='Error.Search anew';
		}
?>
<div class="container">
  <div class="row">
    ...
    <div class="col-6">
  <form action="http://localhost/hotel/upsub.php" method="get" >
    <div class="form-group">
      <label for="id">Customer ID</label>
    <input type="text" class="form-control" id="id" name="id"  value="<?php echo $cid?>" disabled>
  </div>



  <div class="form-group">
      <label for="cid">Confirm Customer ID</label>
    <input type="text" class="form-control" id="cid" name="cid" required>
  </div>
      
  <center>
  <button type="submit" class="btn btn-primary" style="width: 150px; background-color: black">UPDATE NOW</button>
  </center>	
</form>
</div>
    <div class="col">
