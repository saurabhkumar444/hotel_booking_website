...
<footer class="page-footer font-small blue pt-3" style="background-color:Gray;">
  <div class="row">
   ...
   <div class="container-fluid text-center text-md-center col-md-8" style="font-family: fantasy; font-size:20px; background-color: lightgray; font-color: gray">
    <B>CANCEL BOOKING - Confirm Cancel </B>
  </div>
  <div class="col-md-2">
   </div>
</div>
...
if ($conn->query($mysql) == TRUE) {
	...
	if($user==$username){
		...
		{
			echo "<center><h2><b>VERIFIED USER!!!</b></h2></center>";
		}
		else{
...
<div class="container">
  <div class="row">
    ...
    <div class="col-6">
  <form action="delpop.php" method="get" >
    <div class="form-group">
      <label for="id">Registration ID</label>
    <input type="text" class="form-control" id="id" name="id"  value="<?php echo $cid?>" disabled>
  </div>
  <div class="form-group">
      <label for="id"> Confirm Registration ID</label>
    <input type="text" class="form-control" id="id" name="id"  required>
  </div>

  <center>
  <button type="submit" class="btn btn-primary" style="width: 150px; background-color: black">CANCEL BOOKING</button>
  </center>	
